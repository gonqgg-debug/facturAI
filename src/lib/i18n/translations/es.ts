export const es = {
  ...
  users: {
    ...
    inviteEmail: 'Email del Usuario',
    inviteDescription: 'El usuario recibirá un email con un enlace para crear su cuenta.',
    ...
    linkCopied: 'Copiado',
    shareLink: 'También puedes compartir este enlace directamente:',
    whatIsFullAccess: '¿Qué incluye la cuenta completa?',
    accessFromAnyDevice: 'Acceso desde cualquier dispositivo',
    loginWithEmail: 'Login con email y contraseña',
    keepsSameRole: 'Mantiene los mismos permisos de su rol',
    pinStillWorks: 'PIN sigue funcionando para POS rápido',
    // Roles
    roles: 'Roles',
