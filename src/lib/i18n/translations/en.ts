export const en = {
  ...
  users: {
    ...
    inviteDescription: 'The user will receive an email with a link to create their account.',
    ...
    copyLink: 'Copy Link',
    linkCopied: 'Copied',
    shareLink: 'You can also share this link directly:',
    whatIsFullAccess: 'What does full access include?',
    accessFromAnyDevice: 'Access from any device',
    loginWithEmail: 'Login with email and password',
    keepsSameRole: 'Keeps same role permissions',
    pinStillWorks: 'PIN still works for quick POS access',
    // Roles
    roles: 'Roles',
    roleName: 'Role Name',
